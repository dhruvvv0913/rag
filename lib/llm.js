...
// The free tier rate-limits aggressively, so 429s are a fact of life:
// retry them (and transient 5xx) with backoff before giving up.
const RETRY_DELAYS_MS = { 429: [5000, 15000, 30000], server: [1000, 2000, 4000] }
...
async function geminiComplete(opts) {
  ...
  if (opts.tools) return { text, toolCalls }
